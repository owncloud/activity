...
Feature: List activity
  ...
  Scenario: move a file between shares shared to different users
    Given these users have been created with default attributes and without skeleton files:
      | username |
      | Alice    |
      | Brian    |
  ...
  Scenario: move a file between shares shared to different groups
    Given these users have been created with default attributes and without skeleton files:
      | username |
      | Alice    |
      | Brian    |
    ...
    And user "Alice" has created folder "FolderForG1"
    And user "Alice" has created folder "FolderForG2"
    And user "Alice" has uploaded file with content "file to move" to "/FolderForG1/textfile0.txt"
    And user "Alice" has shared folder "FolderForG1" with group "grp1"
    And user "Alice" has shared folder "FolderForG2" with group "grp2"
    And user "Brian" has accepted share "/FolderForG1" offered by user "Alice"
    And user "Carol" has accepted share "/FolderForG2" offered by user "Alice"
    And user "David" has accepted share "/FolderForG2" offered by user "Alice"
    When user "Alice" moves file "/FolderForG1/textfile0.txt" to "/FolderForG2/textfile0.txt" using the WebDAV API
    Then the activity number 1 of user "Alice" should match these properties:
      | type             | /^file_moved$/                                                                                                                                                                                                                                                                                                     |
      | user             | /^Alice$/                                                                                                                                                                                                                                                                                                          |
      | affecteduser     | /^Alice$/                                                                                                                                                                                                                                                                                                          |
      | app              | /^files$/                                                                                                                                                                                                                                                                                                          |
      | subject          | /^moved_self$/                                                                                                                                                                                                                                                                                                     |
      | object_name      | /^\/FolderForG2\/textfile0\.txt/                                                                                                                                                                                                                                                                                   |
      | object_type      | /^files$/                                                                                                                                                                                                                                                                                                          |
      | typeicon         | /^icon-move/                                                                                                                                                                                                                                                                                                       |
      | subject_prepared | /^You moved <file link=\"%base_url%\/(index\.php\/)?apps\/files\/\?dir=\/FolderForG1\&scrollto=textfile0\.txt\" id=\"\">FolderForG1\/textfile0\.txt<\/file> to <file link=\"%base_url%\/(index\.php\/)?apps\/files\/\?dir=\/FolderForG2\&scrollto=textfile0\.txt\" id=\"\d+\">FolderForG2\/textfile0\.txt<\/file>/ |
    And the activity number 1 of user "Brian" should match these properties:
      | type             | /^file_deleted/                                                                                                                                                                                                  |
      | user             | /^Alice/                                                                                                                                                                                                         |
      | affecteduser     | /^Brian/                                                                                                                                                                                                         |
      | app              | /^files$/                                                                                                                                                                                                        |
      | subject          | /^deleted_by/                                                                                                                                                                                                    |
      | object_name      | /^\/FolderForG1\/textfile0\.txt/                                                                                                                                                                                 |
      | object_type      | /^files$/                                                                                                                                                                                                        |
      | typeicon         | /^icon-delete/                                                                                                                                                                                                   |
      | subject_prepared | /^<user display-name=\"Alice Hansen\">Alice<\/user> deleted <file link=\"%base_url%\/(index\.php\/)?apps\/files\/\?dir=\/FolderForG1\&scrollto=textfile0\.txt\" id=\"\d+\">FolderForG1\/textfile0\.txt<\/file>$/ |
    And the activity number 1 of user "Carol" should match these properties:
      | type             | /^file_created/                                                                                                                                                                                                  |
      | user             | /^Alice/                                                                                                                                                                                                         |
      | affecteduser     | /^Carol/                                                                                                                                                                                                         |
    ...
    And the activity number 1 of user "David" should match these properties:
      | type             | /^file_created/                                                                                                                                                                                                  |
      | user             | /^Alice/                                                                                                                                                                                                         |
      | affecteduser     | /^David/                                                                                                                                                                                                         |
      | app              | /^files$/                                                                                                                                                                                                        |
