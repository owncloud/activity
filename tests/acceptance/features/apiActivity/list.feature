...
Feature: List activity
  ...
  Scenario: check activity after renaming a shared folder
    ...
    And the activity number 1 of user "Brian" should match these properties:
      ...
      | object_type      | /^files$/                                                                                                                                                                                                                                                          |
      | typeicon         | /^icon-rename/                                                                                                                                                                                                                                                     |
      | subject_prepared | /^<user display-name=\"Alice Hansen\">Alice<\/user> renamed <file link="%base_url%\/(index\.php\/)?apps\/files\/\?dir=\/FOLDER\/\" id=\"\d+\">FOLDER<\/file> to <file link="%base_url%\/(index\.php\/)?apps\/files\/\?dir=\/FOLDER\/\" id=\"\d+\">FOLDER<\/file>$/ |
