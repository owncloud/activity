OC.L10N.register(
    ...
    "_{parameterList} and {linkStart}%n more{linkEnd}_::_{parameterList} and {linkStart}%n more{linkEnd}_" : ["{parameterList} と {linkStart}さらに %n 件{linkEnd}"],
    "in {directory}" : "{directory} の中",
    "This stream will show events like additions, changes & shares" : "このストリームには、追加、変更、共有などのイベントが表示されます。",
    ...
    "Activities by others" : "他の人のアクティビティ",
    "%s and %s" : "%s と %s",
    "Hello %s," : "%s さんこんにちは、",
    "You are receiving this email because the following things happened at %s" : "%s で以下の更新があったことをお知らせします。",
    "* %1$s - %2$s" : "* %1$s - %2$s",
    "_* and %n more _::_* and %n more _" : ["* と その他 %n 件"],
    "You are receiving this email because the following things happened at <a href=\"%s\">%s</a>" : "<a href=\"%s\">%s</a> で以下の更新があったことをお知らせします。",
    "%1$s - %2$s" : "%1$s - %2$s",
    "_and %n more _::_and %n more _" : ["と その他 %n 件"],
    "Activity" : "アクティビティ",
    "List your own file actions in the stream" : "ストリーム上にあなたのファイル操作を表示する",
