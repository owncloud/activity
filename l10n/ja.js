OC.L10N.register(
    ...
    "You are receiving this email because the following things happened at <a href=\"%s\">%s</a>" : "<a href=\"%s\">%s</a> で以下のような更新がありました。このメールはその内容をお知らせします。",
    "%1$s - %2$s" : "%1$s - %2$s",
    "_and %n more _::_and %n more _" : ["と その他 %n 個"],
    "Activity" : "アクティビティ",
    "List your own file actions in the stream" : "ストリーム上にあなたのファイルの操作を表示する",
