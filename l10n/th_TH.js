OC.L10N.register(
    ...
    "Activities by others" : "กิจกรรมของคนอื่น ๆ",
    "%s and %s" : "%s และอีก %s",
    "Hello %s," : "สวัสดี %s",
    ...
    "You are receiving this email because the following things happened at <a href=\"%s\">%s</a>" : "คุณได้รับอีเมลนี้เนื่องจากเกิดเหตุการณ์ต่อไปนี้ <a href=\"%s\">%s</a>",
    "%1$s - %2$s" : "%1$s - %2$s",
    "_and %n more _::_and %n more _" : ["และมากกว่า %n "],
    "Activity" : "กิจกรรม",
    "List your own file actions in the stream" : "รายการสิ่งที่คุณทำกับไฟล์ของคุณในสตรีม",
