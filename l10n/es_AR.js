OC.L10N.register(
    ...
    "_{parameterList} and {linkStart}%n more{linkEnd}_::_{parameterList} and {linkStart}%n more{linkEnd}_" : ["{parameterList} y {linkStart}%n mas {linkEnd}","{parameterList} y {linkStart}%n mas {linkEnd}","{parameterList} y {linkStart}%n mas {linkEnd}"],
