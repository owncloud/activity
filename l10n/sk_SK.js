OC.L10N.register(
    ...
    "_{parameterList} and {linkStart}%n more{linkEnd}_::_{parameterList} and {linkStart}%n more{linkEnd}_" : ["{parameterList} a {linkStart}%n ďalší{linkEnd}","{parameterList} a {linkStart}%n ďalšie{linkEnd}","{parameterList} a {linkStart}%n ďalších{linkEnd}"],
