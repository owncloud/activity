OC.L10N.register(
    ...
    "_{parameterList} and {linkStart}%n more{linkEnd}_::_{parameterList} and {linkStart}%n more{linkEnd}_" : ["{parameterList} och {linkStart}%n mer{linkEnd}","{parameterList} och {linkStart}%n fler{linkEnd}"],
    ...
    "Activity notification" : "Aktivitetsnotis",
    ...
    "* %1$s - %2$s" : "* %1$s - %2$s",
    "_* and %n more _::_* and %n more _" : ["* och %n mer","* och %n fler"],
    "You are receiving this email because the following things happened at <a href=\"%s\">%s</a>" : "Du får detta e-postmeddelande för att följande saker hände hos  <a href=\"%s\">%s</a>",
    "%1$s - %2$s" : "%1$s - %2$s",
    "_and %n more _::_and %n more _" : ["och %n fler","och %n till"],
    "Activity" : "Aktivitet",
    "List your own file actions in the stream" : "Lista dina egna filhändelser i flödet",
    "Notify about your own actions via email" : "Skicka e-postnotiser gällande din egna aktivitet",
