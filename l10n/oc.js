OC.L10N.register(
    ...
    "Load more activities" : "Cargar mai d'activitats",
    ", " : ", ",
    "{parameterList} and {lastParameter}" : "{parameterList} e {lastParameter}",
    "_{parameterList} and {linkStart}%n more{linkEnd}_::_{parameterList} and {linkStart}%n more{linkEnd}_" : ["{parameterList} e {linkStart}%n autre{linkEnd}","{parameterList} e {linkStart}%n autres{linkEnd}"],
    "in {directory}" : "dins {directory}",
    ...
    "Activity" : "Activitat",
    "List your own file actions in the stream" : "Fa la lista de vòstras pròprias accions dins lo flux",
