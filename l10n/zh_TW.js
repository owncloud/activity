OC.L10N.register(
    ...
    "You are receiving this email because the following things happened at <a href=\"%s\">%s</a>" : "因為發生以下的事情所以你收到這封郵件 <a href=\"%s\">%s</a>",
    "%1$s - %2$s" : "%1$s - %2$s",
    "_and %n more _::_and %n more _" : ["和其他%n個"],
    "Activity" : "活動",
    "List your own file actions in the stream" : "在串流中列出您的活動狀態",
