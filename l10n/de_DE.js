OC.L10N.register(
    ...
    "You are receiving this email because the following things happened at <a href=\"%s\">%s</a>" : "Du erhältst diese E-Mail, da folgende Ereignisse auf <a href=\"%s\">%s</a>geschehen sind ",
    "%1$s - %2$s" : "%1$s - %2$s",
