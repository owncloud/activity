OC.L10N.register(
    ...
    "_{parameterList} and {linkStart}%n more{linkEnd}_::_{parameterList} and {linkStart}%n more{linkEnd}_" : ["{parameterList} e {linkStart}%n altro{linkEnd}","{parameterList} e {linkStart}%n altri{linkEnd}","{parameterList} e {linkStart}%n altri{linkEnd}"],
    ...
    "* %1$s - %2$s" : "* %1$s - %2$s",
    "_* and %n more _::_* and %n more _" : ["* e %n altra","* e %n altre","* e %n altre"],
    "You are receiving this email because the following things happened at <a href=\"%s\">%s</a>" : "Hai ricevuto questa email perché si sono verificati i seguenti eventi su <a href=\"%s\">%s</a>",
    "%1$s - %2$s" : "%1$s - %2$s",
    "_and %n more _::_and %n more _" : ["e %n altra","e %n altre","e %n altre"],
    "Activity" : "Attività",
