OC.L10N.register(
    ...
    "Load more activities" : "Загрузить больше событий",
    ", " : ",",
    "{parameterList} and {lastParameter}" : "{списокПараметров} и {последнийПараметр}",
    "_{parameterList} and {linkStart}%n more{linkEnd}_::_{parameterList} and {linkStart}%n more{linkEnd}_" : ["{parameterList} и {linkStart}еще %n{linkEnd}","{parameterList} и {linkStart}еще %n{linkEnd}","{parameterList} и {linkStart}еще %n{linkEnd}","{списокПараметров} и {Начало}еще %n{Конец}"],
    "in {directory}" : "в {папку}",
